...
//TFile *f = new TFile("../job_opt2_100m/all.root","");
//TTree *t = (TTree*)f->Get("T1");

TChain *t = new TChain("T1");
t->Add(infile);
//t->Add("/home/pku/yuxd/bond/PKMUON_Moutain_G4sim/Background/analysis/job_opt2_100m/root/muCry_0.root");
//t->Add("/home/pku/yuxd/bond/PKMUON_Moutain_G4sim/Background/analysis/job_opt2_100m/root/*root");
...
//TFile * fn = new TFile("../root/muCry_opt2_100m.root","recreate");
