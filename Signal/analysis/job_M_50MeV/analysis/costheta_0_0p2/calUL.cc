...
double L[6]={100,1000,10000,100000,1000000,10000000};
...
double pvalue_M_500MeV[6];
pvalue_M_500MeV[0] = hbkg->Chi2Test(hsig_M_500MeV_L_100km, "UU,NORM");
pvalue_M_500MeV[1] = hbkg->Chi2Test(hsig_M_500MeV_L_1000km, "UU,NORM");
pvalue_M_500MeV[2] = hbkg->Chi2Test(hsig_M_500MeV_L_10000km, "UU,NORM");
pvalue_M_500MeV[3] = hbkg->Chi2Test(hsig_M_500MeV_L_100000km, "UU,NORM");
pvalue_M_500MeV[4] = hbkg->Chi2Test(hsig_M_500MeV_L_1000000km, "UU,NORM");
pvalue_M_500MeV[5] = hbkg->Chi2Test(hsig_M_500MeV_L_10000000km, "UU,NORM");

double ss_M_500MeV[6];
for (int i=0; i<6; i++) ss_M_500MeV[i] = sqrt(2) * TMath::ErfcInverse( pvalue_M_500MeV[i] );
for (int i=0; i<6; i++) cout<<"L="<<L[i]<<"km, pvalue="<<pvalue_M_500MeV[i]<<", significance="<<ss_M_500MeV[i]<<"sigma"<<endl;

double chi2_M_500MeV[6];
chi2_M_500MeV[0] = hbkg->Chi2Test(hsig_M_500MeV_L_100km, "UU,NORM,CHI2,P");
chi2_M_500MeV[1] = hbkg->Chi2Test(hsig_M_500MeV_L_1000km, "UU,NORM,CHI2,P");
chi2_M_500MeV[2] = hbkg->Chi2Test(hsig_M_500MeV_L_10000km, "UU,NORM,CHI2,P");
chi2_M_500MeV[3] = hbkg->Chi2Test(hsig_M_500MeV_L_100000km, "UU,NORM,CHI2,P");
chi2_M_500MeV[4] = hbkg->Chi2Test(hsig_M_500MeV_L_1000000km, "UU,NORM,CHI2,P");
chi2_M_500MeV[5] = hbkg->Chi2Test(hsig_M_500MeV_L_10000000km, "UU,NORM,CHI2,P");

double ndf = hbkg->GetNbinsX() - 1;
double pdf_M_500MeV[6];
for(int i=0; i<6; i++) pdf_M_500MeV[i] = ROOT::Math::chisquared_pdf(chi2_M_500MeV[i], ndf);

double km2cm = 1e5;
double sigma_M_500MeV[6];
for(int i=0; i<6; i++) sigma_M_500MeV[i] = L2sigma(0.5, L[i]*km2cm);


TGraph* graph = new TGraph(6, sigma_M_500MeV, pdf_M_500MeV);
